function [time_gen,Q_gen,R_gen,I_gen,soil_saturation_gen,L_gen,ET_gen,Pgen_hourly,Q_gen_mean_monthly] = GroupD_f_discharge(Nyears_gen, P, temperature, kc, dt, n, max_z,max_Kc,sw,s1,max_c,tsup,max_tsub,A,Qb,phi,doTest)
