function [Q, R, I,s,L,ET] = GroupD_f_hydromodel(phi,temperature,n_years,P,Ksat,sw,s1,kc,n,Qb,tsup,tsub,A,c,dt,z, doTest)
...
% For a linear reservoir scheme, calculations of total discharge arriving in reservoir
